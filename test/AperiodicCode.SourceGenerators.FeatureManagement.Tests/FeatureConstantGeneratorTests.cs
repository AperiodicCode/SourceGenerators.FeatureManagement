...
namespace AperiodicCode.SourceGenerators.FeatureManagement.Tests;

[UsesVerify]
public class FeatureConstantGeneratorTests
{
    [Fact]
    ...
    private static Project CreateBaseProject()
    {
        ...
        foreach (var defaultCompileLibrary in DependencyContext.Load(typeof(FeatureConstantGeneratorTests).Assembly)!.CompileLibraries)
        {
    ...
    {
        var sourceGenerator = new FeatureConstantGenerator().AsSourceGenerator();
